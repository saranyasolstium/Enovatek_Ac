...
class InVoicePDFViewerScreen extends StatefulWidget {
  ...
  @override
  InVoicePDFViewerScreenState createState() => InVoicePDFViewerScreenState();
}

class InVoicePDFViewerScreenState extends State<InVoicePDFViewerScreen> {
  String? _pdfPath;
  ...
  Future<void> downloadInvoice() async {
    ...
    Response response = await RemoteServices.downloadInvoiceBeforePayment(
        widget.deviceId, widget.month, authToken!);
  ...
  Future<void> _downloadPdf() async {
    ...
    try {
      ...
      http.Response response =
          await RemoteServices.downloadInvoiceBeforePayment(
              widget.deviceId, widget.month, authToken!);
